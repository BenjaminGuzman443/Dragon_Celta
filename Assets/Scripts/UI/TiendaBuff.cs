...
namespace DragonCeltas
{
    ...
    public class ItemTiendaBuff
    {
        ...
        public EfectoTiendaBuff efecto;
    }

    public class TiendaBuff : MonoBehaviour, ITienda
    {
        [Header("Canvas")]
        [SerializeField] private GameObject canvasTienda;

        [Header("Items de la Tienda")]
        [SerializeField] private ItemTiendaBuff[] itemsTienda;
        ...
        private void ComprarItem(int index)
        {
            ...
            switch (item.efecto)
            {
                case EfectoTiendaBuff.BuffAleatorio:
                    playerUpgrades.ActivarMejoraGratis();
                    break;
                case EfectoTiendaBuff.EscudoVida:
                    if (playerHealth != null)
                        playerHealth.AplicarEscudo(2.5f);
                    break;
                case EfectoTiendaBuff.BuenaSuerte:
                    playerUpgrades.ActivarMejoraBuenaSuerte();
                    break;
            }
        }
